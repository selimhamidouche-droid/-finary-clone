"""
Django settings for wealthgravity project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-ag2tyxa_4$@d25t_x19#rmzh#g&ebvmz2wzdr(w30(_3m+5=fm')
...
ROOT_URLCONF = 'wealthgravity.urls'
...
WSGI_APPLICATION = 'wealthgravity.wsgi.application'
...
ACCOUNT_EMAIL_VERIFICATION = 'none' # Simplified for MVP, change to 'mandatory' for prod
